...
<head>
	...
	<title>LLR Correction Form</title>
	<style type="text/css">
		table{
			padding-top: 30px;
			margin-right: auto;
...
<div class="navbar" >
  ...
  <a href="home.html">Home</a>
	...
	<h2 style="text-align: center;color: green;">LLR Correction form</h2>
	<form name="llr" method="post" action="llrcorrection3.php" enctype="multipart/form-data">
		<fieldset>
		<table align="center">
			<tr>
